          ...
          <div class="row" >
            <div class="col-xl-4 col-lg-4 mb-50">
              <div class="footer-widget">
                {/* <div class="footer-logo">
                  ...
                  <div className="img-container" style={{marginLeft:"115px"}}>
                  <img 
            ...
            />
                ...
                <div class="footer-social-icon">
                  <span className="mb-3"style={{marginTop:"40px"}}>Follow us</span>
                  <a href="#">
                   <Facebook/>
                  </a>
                  <a href="#">
          ...
          <div class="row">
            <div class="col-xl-6 col-lg-6 text-center pt-3 ">
              <div class="copyright-text">
                <p>Copyright &copy; 2025, All Rights Reserved by Jagdamba Sales Corporation</p>
              </div>
            </div>
