          ...
          <Row className="pt-3 pb-3">
            <Col lg={12}>
              <Row>
                ...
                {/* Product Info */}
                <Col lg={7} md={6} sm={12} className="product-info">
                  <h1 className="h4 product-title">{product.name}</h1>
                  ...
                  {/* Capacity */}
                  <div className="product-capacity mb-4">
                  ...
                  {/* Action Buttons */}
                  <div className="product-actions d-flex flex-wrap gap-2 mb-4">
                    <Button
                      variant="primary"
                      className="d-flex align-items-center justify-content-center gap-2 action-btn"
                ...
                <Col lg={12} className="mt-4">
                  <Tabs defaultActiveKey="home" id="product-details-tabs" className="mb-4 product-tabs">
                    {/* Description Tab */}
