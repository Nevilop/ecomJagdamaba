...
import "./FridgeList.css"; // Import your CSS file here
  ...
  return (
    <div>
      ...
      <Container
        fluid
        className="py-4"
        style={{ marginTop: "200px", paddingRight: "15px", paddingLeft: "15px" }}
      >
        <Row>
          ...
          <Col lg={3} className="d-none d-lg-block">
            <Card className="shadow-sm border-0 mb-4 sticky-top" style={{ top: "1rem", margin:"0 auto",height:"90%" }}>
